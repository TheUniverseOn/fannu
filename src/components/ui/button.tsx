...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-semibold ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-gradient-primary text-white hover:shadow-glow-purple rounded-full",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90 rounded-full",
        outline:
          "border-[1.5px] border-border bg-transparent hover:bg-muted rounded-full",
        secondary:
          "bg-card text-foreground hover:bg-muted rounded-full",
        ghost: "hover:bg-muted/50 rounded-lg",
        link: "text-primary underline-offset-4 hover:underline",
        accent: "bg-fannu-purple text-white hover:bg-fannu-purple-hover rounded-full",
      },
      size: {
